...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        newstdev=math.sqrt(self.n*self.p*(1-self.p))
        self.stdev=newstdev
        return newstdev
    ...
    def plot_bar(self):
        ...
        x=[0,1]
        y=[len(self.data)-sum(self.data),sum(self.data)]
        plt.bar(x,y)
        plt.xlabel('outcome')
        plt.ylabel('counts')
    ...
    def pdf(self, k):
        ...
        dinometor=math.factorial(k)*math.factorial(self.n-k)
        return numerator/dinometor
    def plot_bar_pdf(self):
        ...
        plt.title('Probability density for the binomial distribution');
