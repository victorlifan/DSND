...
# fourth chart shows rural population vs arable land
    ...
    keepcolumns=['Country Name','2015','Indicator Name']
    value_variables=['2015']
    
    df = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv',keepcolumns,value_variables)
